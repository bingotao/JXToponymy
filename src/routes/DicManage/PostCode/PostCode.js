...
class PostCode extends Component {
  ...
  async getCommunities(e) {
    // 获取社区时清空原有条件
    if (this.state.State === '') this.queryCondition.CommunityName = null;
    this.setState({
      communities: [],
      communityCondition: null,
    });
      ...
      <div className={st.PostCode}>
        ...
        >
          <Form>
            ...
            <FormItem labelCol={{ span: 4 }} wrapperCol={{ span: 16 }} label="邮政编码">
              {getFieldDecorator('Postcode', {
                ...
                <Input
                  onChange={e => this.changeModifyPost(e.target.value)}
                  placeholder="邮政编码"
                />
              )}
            </FormItem>
