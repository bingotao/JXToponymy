                    ...
                    <Form>
                        ...
                        >
                            {getFieldDecorator('Type', {
                                rules: [{
                                    required: true, message: '门牌类型不能为空',
                                }],
                        ...
                        >
                            {getFieldDecorator('Size', {
                                rules: [{
                                    required: true, message: '门牌规格不能为空',
                                }],
                                initialValue: entity.Size,

                            })(
                                <Input onChange={e => this.changeMPSize(e.target.value)}
                                    placeholder="门牌规格" />
                            )}
                        </FormItem>
                        <FormItem
                        ...
                        >
                            {getFieldDecorator('Material', {
                                ...
                                <Input onChange={e => this.changeMPMaterial(e.target.value)}
                                    placeholder="门牌材质" />
                            )}
                        </FormItem>
                    </Form>
