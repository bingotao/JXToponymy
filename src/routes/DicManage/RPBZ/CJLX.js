...
class CJLX extends Component {
  ...
  addRPBZ() {
    this.setState({ showModal: true, modalTitle: '厂家类型新增', modify: false });
  }
  ...
  validate(errs, bAdrress) {
    ...
    if (entity.LX === undefined || entity.LX == null) entity.LX = '厂家类型';
    let saveObj = entity;
    return { errs, saveObj };
  }
  ...
  async onEdit(i) {
    ...
    rtHandle(rt, d => {
      ...
      this.setState({ showModal: true, entity: d, modalTitle: '厂家类型修改', modify: true });
    });
  }
