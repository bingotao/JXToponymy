...
class RPLX extends Component {
  ...
  addRPBZ() {
    this.setState({ showModal: true, modalTitle: '路牌类型新增', modify: false });
  }
  closeModal() {
  ...
  async onEdit(i) {
    ...
    rtHandle(rt, d => {
      ...
      this.setState({ showModal: true, entity: d, modalTitle: '路牌类型修改', modify: true });
    });
  }
