...
// 办事事项-门牌管理
let Bssx_mpgl = ['门牌管理的办事事项，申请门（楼）牌号码及门牌证','申请变更门牌证','申请换（补）发门牌证','注销门（楼）牌号码及门牌证'];
// 办事事项-地名管理
let Bssx_dmgl = ['住宅小区（楼）、建筑物预命名','住宅小区（楼）命名','新建道路（含街、巷、桥梁、隧道、轨道交通线路）命名','住宅小区（楼）更名','申请换（补）发地名核准书'];
